...
model Test_ConductionElement_Pipe_CondensingAir "Test of heat exchanger Conduction Element for Condensing Gas"
  ...
  ThermofluidStream.Boundaries.Sink sink_waterChannel(redeclare package Medium = Medium_WaterChannel, p0_par=100000) annotation (Placement(transformation(extent={{120,-60},{140,-40}})));
...
equation
  ...
  connect(conductionElement.outlet_water, MassFlow_WaterOut_Sensor.inlet) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(EnthalpyFlow_WaterOut_Sensor.outlet, sink_waterChannel.inlet) annotation (Line(
  ...
  connect(MassFlow_AirOut_Sensor.outlet, EnthalpyFlow_AirOut_Sensor.inlet) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(EnthalpyFlow_AirOut_Sensor.outlet, sink_AirChannel.inlet) annotation (Line(
  ...
  annotation (
    ...
    __Dymola_Commands);
end Test_ConductionElement_Pipe_CondensingAir;
