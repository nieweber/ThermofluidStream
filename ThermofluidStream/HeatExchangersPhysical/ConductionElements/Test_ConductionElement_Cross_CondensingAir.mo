...
model Test_ConductionElement_Cross_CondensingAir "Test of heat exchanger Cross Flow Conduction Element for Condensing Gas"
  ...
  ConductionElements.ConductionElement_Cross_CondensingAir conductionElement_Cross(redeclare package Medium_Water = Medium_Water) annotation (Placement(transformation(extent={{-20,-40},{20,0}})));
  ...
  ThermofluidStream.Boundaries.TerminalSource terminalSource(redeclare package Medium = Medium_Water,                                        p_0=100100) annotation (Placement(transformation(extent={{-54,-42},{-34,-22}})));
  ...
  ThermofluidStream.Boundaries.Sink sink(redeclare package Medium = Medium_Water, p0_par=100000)                                        annotation (Placement(transformation(extent={{120,-60},{140,-40}})));
  ...
  ThermofluidStream.Sensors.SingleSensorSelect Temperature_WaterOut_Sensor(redeclare package Medium = Medium_Water, quantity=ThermofluidStream.Sensors.Internal.Types.Quantities.T_C) annotation (Placement(transformation(extent={{86,-72},{106,-52}})));
...
equation
  ...
  connect(mCV_cross.outlet, phi_CrossIn_Sensor.inlet) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(conductionElement_Cross.outlet_water, MassFlow_WaterOut_Sensor.inlet) annotation (Line(
      points={{20,-32},{34,-32},{34,-50},{50,-50}},
      color={28,108,200},
      thickness=0.5));
  connect(EnthalpyFlow_WaterOut_Sensor.outlet, sink.inlet) annotation (Line(
      points={{106,-50},{120,-50}},
      color={28,108,200},
      thickness=0.5));
  ...
  annotation (
    ...
    __Dymola_Commands);
end Test_ConductionElement_Cross_CondensingAir;
