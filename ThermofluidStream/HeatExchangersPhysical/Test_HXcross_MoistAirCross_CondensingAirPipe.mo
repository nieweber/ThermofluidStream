...
model Test_HXcross_MoistAirCross_CondensingAirPipe
...
//                                                        annotation(choicesAllMatching = true);
  ...
  HX_1PhaseCross_CondensingAirPipe hXcross(
    redeclare package Medium_CrossChannel = Medium_CrossChannel,
    redeclare package Medium_PipeChannel = Medium_PipeChannel,
    redeclare package Medium_Water = Medium_Water) annotation (Placement(transformation(extent={{-20,-40},{20,0}})));
...
equation
  ...
  connect(hXcross.outlet_Pipe, Temperature_PipeOut_Sensor.inlet) annotation (Line(
      points={{0,0.4},{0,18},{16,18}},
      color={28,108,200},
      thickness=0.5));
  connect(hXcross.outlet_Pipe, Enthalpy_PipeOut_Sensor.inlet) annotation (Line(
      points={{0,0.4},{0,18},{10,18},{10,28},{16,28}},
      color={28,108,200},
      thickness=0.5));
  ...
  connect(Temperature_WaterOut_Sensor.inlet,MassFlow_WaterOut_Sensor. outlet) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(hXcross.outlet_pipe_water, MassFlow_WaterOut_Sensor.inlet) annotation (Line(
      points={{8,-0.4},{8,10},{50,10}},
      color={28,108,200},
      thickness=0.5));
  connect(EnthalpyFlow_PipeIn_Sensor.outlet, hXcross.inlet_Pipe) annotation (Line(
      points={{-20,-60},{0,-60},{0,-40.4}},
      color={28,108,200},
      thickness=0.5));
  ...
  connect(EnthalpyFlow_CrossOut_Sensor.outlet, flowResistance_Cross.inlet) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(hXcross.outlet_Cross, MassFlow_CrossOut_Sensor.inlet) annotation (Line(
      points={{20.8,-20},{40,-20}},
      color={28,108,200},
      thickness=0.5));
  ...
  connect(source_PipeChannel.outlet, MassFlow_PipeIn_Sensor.inlet) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(MassFlow_PipeOut_Sensor.inlet, hXcross.outlet_Pipe) annotation (Line(
      points={{0,40},{0,0.4}},
      color={28,108,200},
      thickness=0.5));
  ...
  connect(Temperature_PipeIn_Sensor.inlet, EnthalpyFlow_PipeIn_Sensor.outlet) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(Humidity_PipeOut_SensorX.inlet, hXcross.outlet_Pipe) annotation (Line(
      points={{-12,18},{0,18},{0,0.4}},
      color={28,108,200},
      thickness=0.5));
  ...
  connect(phi_PipeIn_Sensor.inlet, EnthalpyFlow_PipeIn_Sensor.outlet) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(phi_PipeOut_Sensor.inlet, hXcross.outlet_Pipe) annotation (Line(
      points={{-16,30},{0,30},{0,0.4}},
      color={28,108,200},
      thickness=0.5));
  connect(mCV_pipe.outlet, sink_PipeChannel.inlet) annotation (Line(
      ...
      thickness=0.5));
  annotation (
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-180,-100},{140,120}})),
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-180,-100},{140,120}}), graphics={
        Text(
          extent={{-52,94},{-12,72}},
          textColor={0,0,0},
...
end Test_HXcross_MoistAirCross_CondensingAirPipe;
